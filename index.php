...
<body class="font-sans bg-gray-50">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-xl font-bold text-blue-800 hidden sm:inline">Skydent.com</span>
                </div>
    ...
    <main>
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">Support Availability</p>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-blue-600 mb-2">500+</div>
                        <p class="text-gray-600">Dental Partners</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- About Us -->
        <section class="py-20 bg-gradient-to-b from-blue-50/30 to-white">
            <div class="container mx-auto px-4 max-w-7xl">
                <!-- SEO-Optimized Header -->
                <header class="text-center mb-16" role="banner" aria-labelledby="team-heading">
                    <span class="inline-block px-4 py-2 text-sm font-semibold text-blue-700 bg-blue-100 rounded-full mb-4 uppercase tracking-wide">Our Expertise</span>
                    <h1 id="team-heading" class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Dedicated Dental Lab Team & Operations</h1>
                    <div class="w-24 h-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 mx-auto mb-6 rounded-full" aria-hidden="true"></div>
                    <p class="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">Meet the specialized professionals and streamlined processes that deliver precision dental restorations to labs worldwide.</p>
                </header>

                <!-- Main Content -->
                <div class="flex flex-col lg:flex-row items-center gap-12 mb-16">
                    <!-- Image/Visual Content -->
                    <div class="lg:w-1/2" aria-hidden="true">
                        <div class="relative">
                            <div class="w-full h-96 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl overflow-hidden shadow-lg flex items-center justify-center">
                                <div class="text-center p-8">
                                    <div class="w-24 h-24 bg-white rounded-full shadow-md flex items-center justify-center mx-auto mb-6">
                                        <i class="fas fa-heartbeat text-blue-600 text-4xl" aria-hidden="true"></i>
                                    </div>
                                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Passion Meets Precision</h2>
                                    <p class="text-gray-600">Hands-on partners dedicated to your success</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/2">
                        <h2 class="text-3xl font-bold text-gray-900 mb-6">
                            <i class="fas fa-hands-helping text-blue-600 mr-3" aria-hidden="true"></i> Partnership Approach to Dental Design
                        </h2>
                        ...
                        <p class="text-lg text-gray-700 mb-8 leading-relaxed">
                            With 3Shape-certified expertise and commitment to accuracy, each design undergoes meticulous review and refinement. We treat every case as if it were for our own laboratory, maintaining the highest standards without compromise.
                        </p>
                        ...
                        <div class="mt-8 flex flex-wrap gap-4">
                            <div class="bg-blue-100 text-blue-800 px-4 py-2 rounded-lg font-medium flex items-center">
                                <i class="fas fa-certificate text-blue-600 mr-2" aria-hidden="true"></i>
                                3Shape Certified
                            </div>
                            <div class="bg-green-100 text-green-800 px-4 py-2 rounded-lg font-medium flex items-center">
                                <i class="fas fa-award text-green-600 mr-2" aria-hidden="true"></i>
                                Quality Guarantee
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    <!-- Design Team -->
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-blue-50">
                        <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                            <i class="fas fa-pencil-alt text-blue-600 text-2xl" aria-hidden="true"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Design Team</h3>
                        <p class="text-gray-600 text-center mb-4">Certified professionals focused on precision and aesthetics</p>
                        <div class="bg-blue-50 p-3 rounded-lg">
                            <div class="flex justify-between items-center text-sm mb-1">
                                <span class="text-gray-600">Certification Rate</span>
                    ...
                    <!-- Operations -->
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-50">
                        <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                            <i class="fas fa-tasks text-green-600 text-2xl" aria-hidden="true"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Operations</h3>
                        <p class="text-gray-600 text-center mb-4">Streamlined workflow and turnaround management</p>
                        <div class="flex justify-center space-x-4 mt-4">
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white mx-auto text-sm">
                                    <i class="fas fa-clock" aria-hidden="true"></i>
                                </div>
                                <span class="text-xs mt-1 block text-gray-600">Tracking</span>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white mx-auto text-sm">
                                    <i class="fas fa-shipping-fast" aria-hidden="true"></i>
                                </div>
                                <span class="text-xs mt-1 block text-gray-600">Delivery</span>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white mx-auto text-sm">
                                    <i class="fas fa-chart-line" aria-hidden="true"></i>
                                </div>
                                <span class="text-xs mt-1 block text-gray-600">Workflow</span>
                            </div>
                        </div>
                    </div>

                    <!-- Client Relations -->
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-purple-50">
                        <div class="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                            <i class="fas fa-handshake text-purple-600 text-2xl" aria-hidden="true"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Client Relations</h3>
                        <p class="text-gray-600 text-center mb-4">Dedicated communication and preference management</p>
                        <div class="bg-purple-50 p-3 rounded-lg mt-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-purple-700">Personal account manager for each client</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Global Reach -->
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-teal-50">
                        <div class="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                            <i class="fas fa-globe-americas text-teal-600 text-2xl" aria-hidden="true"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Global Reach</h3>
                        <p class="text-gray-600 text-center mb-4">Serving dental labs across four continents</p>
                        <div class="grid grid-cols-2 gap-3 mt-4">
                            <div class="flex items-center">
                                <span class="text-xl mr-2" aria-hidden="true">🇺🇸</span>
                                <span class="text-sm text-gray-700">USA: 80+</span>
                            </div>
                            <div class="flex items-center">
                                <span class="text-xl mr-2" aria-hidden="true">🇨🇦</span>
                                <span class="text-sm text-gray-700">Canada: 11+</span>
                            </div>
                            <div class="flex items-center">
                                <span class="text-xl mr-2" aria-hidden="true">🇬🇧</span>
                                <span class="text-sm text-gray-700">UK: 9+</span>
                            </div>
                            <div class="flex items-center">
                                <span class="text-xl mr-2" aria-hidden="true">🇦🇺</span>
                                <span class="text-sm text-gray-700">Australia: 11+</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Shift Team -->
                <div class="mb-16">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Our Shift Leadership</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div class="text-center bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="w-20 h-20 bg-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl">
                                <i class="fas fa-sun" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Morning Shift</h3>
                            <p class="text-blue-600 font-medium mb-2">Lead Designer</p>
                            <p class="text-gray-600">Case preparation and initial design</p>
                        </div>

                        <div class="text-center bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="w-20 h-20 bg-green-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl">
                                <i class="fas fa-cloud-sun" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Day Shift</h3>
                            <p class="text-green-600 font-medium mb-2">Senior Technician</p>
                            <p class="text-gray-600">Primary design and refinement</p>
                        </div>

                        <div class="text-center bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="w-20 h-20 bg-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl">
                                <i class="fas fa-moon" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Evening Shift</h3>
                            <p class="text-purple-600 font-medium mb-2">Quality Specialist</p>
                            <p class="text-gray-600">Final review and approval</p>
                        </div>

                        <div class="text-center bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="w-20 h-20 bg-indigo-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl">
                                <i class="fas fa-stars" aria-hidden="true"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Night Shift</h3>
                            <p class="text-indigo-600 font-medium mb-2">Support Manager</p>
                            <p class="text-gray-600">Client communication and support</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md p-8 mb-16">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-10">Daily Case Statistics</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-6 text-center">Case Distribution</h3>
                            <div class="space-y-5">
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-gray-700 font-medium">Crowns</span>
                                        <span class="text-blue-600 font-semibold">45%</span>
                                    </div>
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-gray-700 font-medium">Bridges</span>
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-gray-700 font-medium">Implants</span>
                                        <span class="text-purple-600 font-semibold">20%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-3">
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-gray-700 font-medium">Aligners</span>
                        ...
                        <div class="flex items-center justify-center">
                            <div class="text-center">
                                <div class="text-5xl font-bold text-blue-600 mb-2">111+</div>
                                <div class="text-xl font-semibold text-gray-700">Total Clients Served</div>
                                <div class="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-200">
                                    <div class="flex items-center">
                                        <i class="fas fa-headset text-blue-600 mr-3" aria-hidden="true"></i>
                                        <p class="text-sm text-blue-700">24/7 support across all time zones</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4 max-w-7xl">
                <div class="text-center mb-12">
                    <h2 class="text-4xl font-bold text-blue-900 mb-4">Premium Dental Lab Solutions</h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">Trusted by hundreds of dental labs nationwide for exceptional quality and reliable service</p>
                </div>
                ...
                <div class="flex flex-col lg:flex-row gap-10">
                        ...
                        <div class="bg-white rounded-xl shadow-md p-8 h-full">
                            ...
                            <div class="mt-10 pt-8 border-t border-gray-200">
                                <div class="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <p class="text-3xl font-bold text-blue-900">99%</p>
                                        <p class="text-gray-600 text-sm">On-Time Delivery</p>
                                    </div>
                                    <div>
                                        <p class="text-3xl font-bold text-blue-900">250+</p>
                    ...
                    <!-- Right Column - How to Start & Pay -->
                    <div class="lg:w-1/2">
                        <div class="bg-gradient-to-br from-blue-900 to-blue-700 rounded-xl shadow-md p-8 h-full text-white">
                            <h2 class="text-3xl font-bold mb-8 pb-4 border-b border-blue-500">How to Start & Pay</h2>
                            ...
                            <div class="flex mb-8 relative">
                                ...
                                <div class="flex-shrink-0 mr-6 z-10">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-700 font-bold text-xl">1</div>
                                </div>
                                <div>
                                    <h3 class="text-xl font-semibold mb-2">Talk to Us</h3>
                                    <p class="text-blue-100">Share your requirements and challenges, and we'll set up your account.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex mb-8 relative">
                                ...
                                <div class="flex-shrink-0 mr-6 z-10">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-700 font-bold text-xl">2</div>
                                </div>
                                <div>
                                    <h3 class="text-xl font-semibold mb-2">Upload Cases</h3>
                                    <p class="text-blue-100">Log in and upload your cases. Choose your preferred turnaround time.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex mb-8 relative">
                                ...
                                <div class="flex-shrink-0 mr-6 z-10">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-700 font-bold text-xl">3</div>
                                </div>
                                <div>
                                    <h3 class="text-xl font-semibold mb-2">Preview & Mill</h3>
                                    <p class="text-blue-100">Review the completed design (STL/finished file) or directly for milling them.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex relative">
                                <div class="flex-shrink-0 mr-6 z-10">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-700 font-bold text-xl">4</div>
                                </div>
                                <div>
                                    <h3 class="text-xl font-semibold mb-2">Make Payment</h3>
                                    <p class="text-blue-100">Pay securely by credit card, debit card, PayPal, or bank transfer (monthly billing available).</p>
                            ...
                            <div class="mt-12 text-center">
                                <button class="bg-white hover:bg-blue-50 text-blue-700 font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-md">
                                    Get Started Today
                                </button>
                                <p class="text-blue-200 text-sm mt-4">No setup fees • Cancel anytime • 30-day satisfaction guarantee</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-16">
            <div class="container mx-auto px-4 max-w-6xl">
                ...
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-blue-900 mb-4">Professional Dental Lab Services</h2>
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">Comprehensive dental design solutions crafted for the daily needs of labs and clinicians</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-blue-50 md:col-span-2 lg:col-span-3 mx-auto" style="max-width: 500px;">
                        <div class="w-14 h-14 bg-blue-100 rounded-lg flex items-center justify-center mb-4 mx-auto text-blue-600">
                            <i class="fas fa-pencil-alt text-xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Digital Wax-Ups & Temporaries</h3>
                        <p class="text-gray-600 text-center">Diagnostic and provisional dental cases.</p>
                    </div>
                </div>

                <!-- CTA Section -->
                <div class="mt-16 text-center">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-6">Need a dental service not listed here?</h3>
                    <p class="text-gray-600 mb-8">We specialize in custom solutions for unique dental lab challenges.</p>
                    <button class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-md">
                        Contact Us About Your Dental Project
                    </button>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
            <div class="container mx-auto px-4 max-w-6xl">
                <!-- Section Header -->
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-blue-900 mb-4">Trust & Credentials</h2>
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">Our commitment to excellence is demonstrated through our certifications, global reach, and proven track record</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-gray-600 text-center">Expert team with senior design oversight for quality assurance</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <p class="text-gray-600 text-center">Serving USA, Canada, UK, Australia with round-the-clock availability</p>
                        <div class="flex justify-center mt-4 space-x-2">
                            <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">🇺🇸 USA</span>
                            <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">🇨🇦 Canada</span>
                            <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">🇬🇧 UK</span>
                            <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">🇦🇺 Australia</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div class="mt-4 bg-gray-50 p-3 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-sm text-gray-600">Crowns</span>
                                <span class="text-sm font-semibold text-purple-700">42%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                            ...
                            <div class="flex justify-between items-center mb-1 mt-2">
                                ...
                                <span class="text-sm font-semibold text-purple-700">31%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-purple-600 h-2 rounded-full" style="width: 31%"></div>
                            </div>
                            <div class="flex justify-between items-center mb-1 mt-2">
                                <span class="text-sm text-gray-600">Implants</span>
                                <span class="text-sm font-semibold text-purple-700">27%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-purple-600 h-2 rounded-full" style="width: 27%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow md:col-span-2">
                        ...
                        <p class="text-gray-600 text-center">Scaled to handle 500+ cases daily with precision and efficiency</p>
                        ...
                        <div class="mt-6 flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div class="text-center mb-6 md:mb-0">
                                <div class="text-3xl font-bold text-teal-700">99.2%</div>
                ...
                <div class="mt-16 bg-white rounded-xl p-8 shadow-md">
                    ...
                    <div class="flex flex-wrap justify-center gap-6">
                        <div class="bg-gray-50 px-6 py-4 rounded-lg border border-gray-200 flex items-center">
                            ...
                            <div>
                                <div class="font-semibold">3Shape Certified</div>
                        ...
                        <div class="bg-gray-50 px-6 py-4 rounded-lg border border-gray-200 flex items-center">
                            ...
                            <div>
                                <div class="font-semibold">Quality Standards</div>
                        ...
                        <div class="bg-gray-50 px-6 py-4 rounded-lg border border-gray-200 flex items-center">
                            ...
                            <div>
                                <div class="font-semibold">EU Compliance</div>
        ...
        <!-- <section class="py-16 bg-white">
            <div class="container mx-auto px-4 max-w-6xl">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-blue-900 mb-4">Our Team & Operations</h2>
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">Meet the dedicated professionals and processes that power our precision dental design services</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Designers</h3>
                        <p class="text-gray-600 text-center">Skilled, certified professionals focused on precision and esthetics.</p>
                        <div class="mt-4 bg-white p-3 rounded-lg border border-blue-100">
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-600">Certified</span>
                                <span class="font-semibold text-blue-700">100%</span>
                            </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Operations Manager</h3>
                        <p class="text-gray-600 text-center">Ensures workflow, turnaround, and tracking.</p>
                        <div class="mt-4 flex justify-center space-x-3">
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center text-white mx-auto text-sm">WF</div>
                                <span class="text-xs mt-1 block">Workflow</span>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center text-white mx-auto text-sm">TA</div>
                                <span class="text-xs mt-1 block">Turnaround</span>
                            </div>
                            <div class="text-center">
                                <div class="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center text-white mx-auto text-sm">TR</div>
                                <span class="text-xs mt-1 block">Tracking</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Relationship Manager</h3>
                        <p class="text-gray-600 text-center">Dedicated to communication and client preferences.</p>
                        <div class="mt-4 bg-white p-3 rounded-lg border border-purple-100">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 text-purple-600">
                                    <i class="fas fa-comments"></i>
                                </div>
                                <div class="ml-3">
                                    <p class="text-sm text-purple-700">Dedicated point of contact for each client</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Daily Case Output</h3>
                        <p class="text-gray-600 text-center">Hundreds of crowns, bridges, implants, and aligners delivered every day.</p>

                        <div class="mt-4 space-y-3">
                            <div>
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-gray-600">Crowns</span>
                                    <span class="text-sm font-semibold text-amber-700">45%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-gray-600">Bridges</span>
                                    <span class="text-sm font-semibold text-amber-700">25%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-gray-600">Aligners</span>
                                    <span class="text-sm font-semibold text-amber-700">10%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow md:col-span-2">
                        <div class="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                            <i class="fas fa-globe-americas text-teal-600 text-2xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2 text-center">Global Clients</h3>
                        <p class="text-gray-600 text-center">Trusted by labs and clinicians in USA, Canada, UK, and Australia.</p>
                        ...
                        <div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="text-center">
                                ...
                                <h4 class="font-semibold text-gray-800">USA</h4>
                                <p class="text-sm text-gray-600">80+ Clients</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <h4 class="font-semibold text-gray-800">Canada</h4>
                                <p class="text-sm text-gray-600">11+ Clients</p>
                            </div>

                            <div class="text-center">
                                <div class="w-16 h-16 bg-purple-50 rounded-full flex items-center justify-center mx-auto mb-2">
                                    <span class="text-2xl">🇬🇧</span>
                                </div>
                                <h4 class="font-semibold text-gray-800">UK</h4>
                                <p class="text-sm text-gray-600">9+ Clients</p>
                            </div>

                            <div class="text-center">
                                <div class="w-16 h-16 bg-yellow-50 rounded-full flex items-center justify-center mx-auto mb-2">
                                    <span class="text-2xl">🇦🇺</span>
                                </div>
                                <h4 class="font-semibold text-gray-800">Australia</h4>
                                <p class="text-sm text-gray-600">11+ Clients</p>
                            </div>
                        </div>

                        <div class="mt-6 bg-teal-50 p-4 rounded-lg border border-teal-100">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 text-teal-600">
                                    <i class="fas fa-headset"></i>
                                </div>
                                <div class="ml-3">
                                    <p class="text-sm text-teal-700">Serving clients across 4 continents with 24/7 support</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-16 text-center">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-6">Ready to join our global client family?</h3>
                    <button class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-md mr-4">
                        Start Your First Case
                    </button>
                    <button class="border border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-3 px-8 rounded-lg transition duration-300">
                        Meet Our Team
                    </button>
                </div>
            </div>
        ...
        <section class="bg-gray-50 py-12" aria-labelledby="testimonials">
            <div class="max-w-6xl mx-auto px-6">
                <!-- SEO Heading -->
                <h2 id="testimonials" class="text-3xl font-bold text-gray-800 text-center mb-10">
                    Case Studies & Testimonials
                </h2>

                <div class="space-y-8">
                    <!-- Testimonial 1 -->
                    <article class="bg-white shadow-md rounded-xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-3 font-semibold text-gray-900">– Lab Owner, USA</p>
                        </div>
                    </article>
                    ...
                    <article class="bg-white shadow-md rounded-xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-3 font-semibold text-gray-900">– Lab Manager, Canada</p>
                        </div>
                    </article>
                    ...
                    <article class="bg-white shadow-md rounded-xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-3 font-semibold text-gray-900">– Lab Owner, UK</p>
                        </div>
                    </article>
                    ...
                    <article class="bg-white shadow-md rounded-xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-3 font-semibold text-gray-900">– Lab Owner, Australia</p>
                        </div>
                    </article>
                    ...
                    <article class="bg-white shadow-md rounded-xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-3 font-semibold text-gray-900">– Dental Lab</p>
                        </div>
                    </article>
                </div>
            </div>
        ...
        <section class="bg-gray-50 py-12 px-4">
            <div class="max-w-7xl mx-auto bg-white shadow-lg rounded-2xl p-8">
                ...
                <p class="text-gray-600 mb-6">📩 Your Reliable Partner for Digital Dental Design</p>
                ...
                <form class="space-y-4">
                    <div>
                        ...
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Clinic / Lab Name</label>
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Email Address</label>
                        <input type="email" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Phone Number</label>
                        <input type="tel" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Service Required (3Shape or Exocad)</label>
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Notes / Instructions</label>
                        <textarea rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"></textarea>
                    </div>

                    <p class="text-gray-600 text-sm mt-2">
                        ⚡ Once submitted, our team will review your requirements and connect with you within a few hours.
                    </p>

                    <button type="submit" class="w-full bg-blue-800 text-white font-semibold py-3 rounded-xl shadow-md hover:bg-blue-900 transition">
                        Send Request
                    </button>
                </form>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-blue-200 hover:text-white">Portal Login</a></li>
                    </ul>
                </div>
                <div>
